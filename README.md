...
<img src="images\MapImage.png"> <a href="https://kyloggingbridge.ukfnrext.org/">View Map</a>
...
<p>The Kentucky Logging Bridge Program along with the map will continue to be updated as this program goes on. We expect this program to continue through 2028 and to be able to provide logging bridges to over 100 loggers throughout that period. This is expected to reduce over 500,000 kg of suspended sediment throughout the programs life. As this program continues we will keep track of bridge locations and add them to the map. I look forward to seeing the overall impact that this program will have for loggers, landowners, and the overall communites that depend on high quality strems.</p>


## Bibliography
Carter, D. R., Arvanitis, L. G., Brackett, D., Boycheva, V., & Sager, S. (1999). A decision support system for timber harvest scheduling. Journal of FORESTRY, 97(6), 12-18.
...
Figorilli, S., Tocci, F., Vasta, S., Colle, G., Sperandio, G., Violino, S.,…Costa, C. (2024). Precision forestry: an open-source IoT digital caliper and app to simplify tree diameter measurements. JOURNAL OF FORESTRY RESEARCH, 35(1), Article 136. https://doi.org/10.1007/s11676-024-01784-w 

Gore, J., Peters, S., & Weber, D. (2022). A participatory trail web map based on open source technologies. INTERNATIONAL JOURNAL OF CARTOGRAPHY, 8(2), 223-242. https://doi.org/10.1080/23729333.2020.1840320 
Haara, A., Pykäläinen, J., Tolvanen, A., & Kurttila, M. (2018a). Use of interactive data visualization in multi-objective forest planning. Journal of environmental management, 210, 71-86.  

Kosakowski, J., Szumilo, M., & Mroz, M. (2010). GEODATA PROCESSING AND WEB MAPPING IN VISTULA LAGOON ECOSYSTEM MANAGEMENT WEBMGS 2010: 1ST INTERNATIONAL WORKSHOP ON PERVASIVE WEB MAPPING, GEOPROCESSING AND SERVICES,  
Panizzoni, G., Magliocchetti, D., Prandi, F., & De Amicis, R. (2015). Interactive virtual planning tools for sustainable forest production in mountain areas. 
...
Reeves, Christopher D., "Effectiveness of Elevated Skid Trail Headwater Stream Crossings in the Cumberland Plateau" (2012). Theses and Dissertations--Forestry and Natural Resources. 7. https://uknowledge.uky.edu/forestry_etds/7

Reisinger, T. W., & Davis, C. J. (1986). A map-based decision support system for evaluating terrain and planning timber harvests. Transactions of the ASAE, 29(5), 1199-1203. 

Sukic, E., & Stoimenov, L. (2012). The Use of Web Mapping Services for Designing e-City Government Web Portals. TECHNICS TECHNOLOGIES EDUCATION MANAGEMENT-TTEM, 7(2), 875-881. 

Walker, R., & Tonning, B. (2006). KENTUCKY BEST MANAGEMENT PRACTICES FOR CONTROLLING EROSION, SEDIMENT, AND POLLUTANT RUNOFF FROM CONSTRUCTION SITES: PLANNING AND TECHNICAL SPECIFICATIONS MANUAL. 

Williamson, T. N., & Crawford, C. G. (2011). Estimation of Suspended‐Sediment Concentration From Total Suspended Solids and Turbidity Data for Kentucky, 1978‐1995 1. JAWRA Journal of the American Water Resources Association, 47(4), 739-749. 

Witt, E. L., Barton, C. D., Stringer, J. W., Bowker, D. W., & Kolka, R. K. (2013). Evaluating best management practices for ephemeral stream protection following forest harvest in the Cumberland Plateau. Southern Journal of Applied Forestry, 37(1), 36-44. 

Stringer, Jefferey (2018). Kentucky Best Management Field Guide

Text generated by (or adapted from) ChatGPT, February 11, 2025, OpenAI, https://chat.openai.com.
